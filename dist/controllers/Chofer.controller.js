...
var ChoferController = /** @class */ (function () {
    function ChoferController(service) {
        this.service = service;
    }
    ChoferController.prototype.getAll = function (req, res, next) {
        var _this = this;
        (function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        choferes = _a.sent();
                        return [2 /*return*/, res.send(200).json(choferes)];
                }
            });
        }); })().catch(next);
    };
    ChoferController.prototype.getOne = function (req, res, next) {
        var _this = this;
        (function () { return __awaiter(_this, void 0, void 0, function () {
            var chofer;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.service.getOne(req.params.Cuil)];
                    case 1:
                        chofer = _a.sent();
                        return [2 /*return*/, res.send(200).json(chofer)];
                }
            });
        }); })().catch(next);
    };
    ChoferController.prototype.create = function (req, res, next) {
        var _this = this;
        (function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    ChoferController.prototype.update = function (req, res, next) {
        var _this = this;
        (function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    ChoferController.prototype.delete = function (req, res, next) {
        var _this = this;
        (function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.service.delete(req.params.Cuil)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/, res.send(200)];
                }
